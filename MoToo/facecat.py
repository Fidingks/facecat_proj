	...
	if chart.datas != None and len(chart.datas) > 0:
		...
		if mp.y >= candleHeight + volHeight + indHeight and mp.y <= candleHeight + volHeight + indHeight + indHeight2:
			if chart.showIndicator2 == "MACD":
				...
				elif selectLines(chart, mp, 3, chart.alldeaarr, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "DEA"
			elif chart.showIndicator2 == "KDJ":
				if selectLines(chart, mp, 3, chart.kdj_k, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "K"
				elif selectLines(chart, mp, 3, chart.kdj_d, index):	
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "D"
				elif selectLines(chart, mp, 3, chart.kdj_j, index):
					chart.selectShape = chart.showIndicator2
				...
				elif selectLines(chart, mp, 3, chart.rsi2, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "12"
				elif selectLines(chart, mp, 3, chart.rsi3, index):
					chart.selectShape = chart.showIndicator2
				...
				elif selectLines(chart, mp, 3, chart.bias2, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "2"
				elif selectLines(chart, mp, 3, chart.bias3, index):
					chart.selectShape = chart.showIndicator2
				...
				elif selectLines(chart, mp, 3, chart.roc_ma, index):
					chart.selectShape = chart.showIndicator2
				...
				if selectLines(chart, mp, 3, chart.wr1, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "1"
				elif selectLines(chart, mp, 3, chart.wr2, index):
				...
				elif selectLines(chart, mp, 3, chart.trix_ma, index):
					chart.selectShape = chart.showIndicator2
				...
				if selectLines(chart, mp, 3, chart.dma1, index):
					chart.selectShape = chart.showIndicator2
					chart.selectShapeEx = "DIF"
				elif selectLines(chart, mp, 3, chart.dma2, index):
					chart.selectShape = chart.showIndicator2
